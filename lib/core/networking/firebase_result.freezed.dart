...
mixin _$FirebaseResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(FirebaseException errorHandler) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(FirebaseException errorHandler)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({FirebaseException errorHandler});
}
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  final FirebaseException errorHandler;
...
abstract class Failure<T> implements FirebaseResult<T> {
  const factory Failure(final FirebaseException errorHandler) =
      _$FailureImpl<T>;

  FirebaseException get errorHandler;
  @JsonKey(ignore: true)
  _$$FailureImplCopyWith<T, _$FailureImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
